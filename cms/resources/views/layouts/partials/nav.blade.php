...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li><a href="{{ url('/destinations') }}"><i class="fa fa-location-arrow"></i>Quản lý điểm đến</a></li>
            <li><a href="{{ url('/partners') }}"><i class="fa fa-hand-peace-o"></i>Quản lý đối tác</a></li>


            <li><a href="{{ url('/solution') }}"><i class="fa fa-cube"></i>Quản lý giải pháp</a></li>
            <li><a href="{{ url('/banner') }}"><i class="fa fa-picture-o"></i>Quản lý banner</a></li>
