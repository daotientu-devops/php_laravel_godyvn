...
<head>
    ...
    <meta name="description" content="Thông tin liên hệ Gody để hợp tác về marketing, quảng cáo, bán hàng, hỗ trợ...">
    ...
    <meta property="og:description"        content="Thông tin liên hệ Gody để hợp tác về marketing, quảng cáo, bán hàng, hỗ trợ..." />
    <meta property="og:image"              content="https://gody.vn/public/images/fb/gody-thumbnail.jpg" />
...
<div class="w-fit d-block ps-relative" style="height: 274px;">
    ...
    <div class="w-fit d-flex ai-center ps-absolute t0" style="height: 274px;">
        <div class="w-fit d-block">
            <h1 class="w-fit d-block fc-white fw-700 fs-48 p-0 m-0 w-fit ta-center">Liên hệ với Gody</h1>
            <h2 class="w-fit d-block fc-white fw-500 lh-25 fs-15 p-0 m-0 w-fit ta-center">Thông tin liên hệ với Gody để hợp tác về marketing, quảng cáo, bán hàng, hỗ trợ,... </h2>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="w-fit d-flex ai-center">
                ...
                <div class="w-fit d-flex" style="justify-content: center!important;">

                    <div class="w-200 ta-center d-flex" style="justify-content: center!important;">
                        <div class="w-fit d-block">
                            <div class="w-fit d-flex  mb-15" style="justify-content: center!important;">
                                <span style="width: 62px;height: 62px;background: #219653;border-radius: 100%;display: flex;justify-content: center!important;align-items: center!important;">
                                <a target="_blank" href="tel:0902456101">
                                    <img
                                            data-src="https://h3jd9zjnmsobj.vcdn.cloud/public/v7/services/passport/Vector (1).png" data-srcset="https://h3jd9zjnmsobj.vcdn.cloud/public/v7/services/passport/Vector (1).png" class="lazy-load" style="width: 31px; height: 31px;">
                                </a>
                                </span>
                            </div>
                            <span
                                    class="fs-16 lh-17 fw-700 ta-center pt-5 fc-black w-fit d-block"
                            >Hotline</span>
                            <a
                                    target="_blank"
                                    href="tel:0902456101"
                                    class="fs-16 lh-17 fw-500 ta-center pt-5 w-fit d-block"
                                    style="color: #828282;"
                            >0902.456.101</a>
                        </div>
                    </div>
                    <div class="w-200 ta-center d-flex" style="justify-content: center!important;">
                        <div class="w-fit d-block">
                            <a
                                    target="_blank"
                                    href="https://m.me/GodyTravel"
                                    class="w-fit d-block mb-15"
                            >
                                <img
                                        data-src="https://h3jd9zjnmsobj.vcdn.cloud/public/v7/services/passport/image 174.png" data-srcset="https://h3jd9zjnmsobj.vcdn.cloud/public/v7/services/passport/image 174.png" class="lazy-load" style="width: 62px; height: 62px;">
                            </a>
                            <span
                                    class="fs-16 lh-17 fw-700 ta-center pt-5 fc-black w-fit d-block"
                            >Messenger</span>
                            <a
                                    ...
                                    href="https://m.me/GodyTravel"
                                    class="fs-16 lh-17 fw-500 ta-center pt-5 w-fit d-block"
                                    style="color: #828282;word-break: break-all;"
                            >m.me/GodyTravel</a>
                        </div>
                    </div>
                    <div class="w-200 ta-center d-flex" style="justify-content: center!important;">
                        <div class="w-fit d-block">
                            ...
                            >
                                <img
                                        data-src="https://h3jd9zjnmsobj.vcdn.cloud/public/v7/services/passport/Ellipse 91.png" data-srcset="https://h3jd9zjnmsobj.vcdn.cloud/public/v7/services/passport/Ellipse 91.png"
                                        class="lazy-load"
...
<section class="p-0 m-0">
    <div class="container">
        <div class="row" style="display: flex;justify-content: center!important;">
            <div class="d-flex ai-center" style="width: 600px;">
                <div class="w-fit d-block">
                    <div class="w-fit d-flex ai-center mb-20">
                        <h2 class="w-fit d-block ta-center fs-36 fc-black fw-600 p-0 m-0">Liên hệ</h2>
                    </div>
                    <form
                            id="form-contact"
                            method="POST"
                            action="https://gody.vn/contact-store"
                    >
                        <input type="hidden" name="_token" value="RwVeLdeMZBiM3GobuQZvQ6wIJmq2n1fyZHEgjYl5" />
                        <div class="w-fit d-flex mb-20">
                            <select
                                    class="w-fit h-60 pl-15 fs-20 bar-8"
                                    style="border: 1px solid #E0E0E0;"
                                    required
                                    required
                                    name="category"
                            >
                                <option value="0">Mục đích liên hệ*</option>
                                <option value="Hợp tác marketing">Hợp tác marketing</option>
                                <option value="Quảng cáo">Quảng cáo</option>
                                <option value="Hợp tác bán hàng">Hợp tác bán hàng</option>
                                <option value="Khác">Khác</option>
                            </select>
                        </div>
                        <div class="w-fit d-flex jc-space-between mb-20">
                            <div
                                    class="ps-relative d-flex fd-column bar-8 ta-center"
                            ...
                            >
                                <input
                                        ...
                                        type="text"
                                        placeholder="Họ*"
                                        class="bar-8 w-fit h-60 p-20 fs-18"
                                        style="color: #828282; border: 1px solid #E0E0E0;"
                                        required
                                />
                            </div>
                            <div
                        ...
                        <div class="w-fit d-flex mb-20">
                            <textarea
                                    name="content"
                                    class="w-fit h-120 bar-8 p-20 fs-18"
                        ...
                        <div class="w-fit d-flex mb-20">
                            <span
                                    value="Gửi"
                                    type="submit"
                                    class="fc-white bg-primary ta-center ai-center fs-20 fw-600 h-60 bar-8 d-flex w-fit h:fc-primary h:bg-white ba bc-primary"
...
<script>
    ...
    {
        const _category = $('select[name="category"]').val(),
            _first_name = $('input[name="first_name"]').val(),
            _last_name = $('input[name="last_name"]').val(),
            _email = $('input[name="email"]').val(),
            _phone = $('input[name="phone"]').val(),
            _content = $('textarea[name="content"]').val();
        if( _category == 0 )
        {
            $('select[name="category"]').addClass('bg-color-red');
            return false;
        }else{
            $('select[name="category"]').removeClass('bg-color-red');
        }
        if( _first_name.length < 2 || _first_name.length > 50 )
        {
            $('input[name="first_name"]').addClass('bg-color-red');
            return false;
        }else{
            $('input[name="first_name"]').removeClass('bg-color-red');
        }
        if( _last_name.length < 2 || _last_name.length > 50 )
        {
            $('input[name="last_name"]').addClass('bg-color-red');
            return false;
        }else{
            $('input[name="last_name"]').removeClass('bg-color-red');
        }
        if( _email.length < 2 || _email.length > 50 )
        {
            $('input[name="email"]').addClass('bg-color-red');
            return false;
        }else{
            $('input[name="email"]').removeClass('bg-color-red');
        }
        if( _phone.length < 2 || _phone.length > 50 )
        {
            $('input[name="phone"]').addClass('bg-color-red');
            return false;
        }else{
            $('input[name="phone"]').removeClass('bg-color-red');
        }
        if( _content.length < 2 )
        {
            $('textarea[name="content"]').addClass('bg-color-red');
            return false;
        }else{
            $('textarea[name="content"]').removeClass('bg-color-red');
        }
        const data = {
        ...
        $.ajax({
            url: 'https://gody.vn/contact-store',
            data: data,
            method: 'POST',
            success: function(data){
                $('#form-contact').trigger("reset");
                $(e).html('Gửi');
                $(e).attr('onlick', 'submitContact(this)');
                swal({
                    text: "Gửi liên hệ thành công. Gody sẽ phản hồi trong thời gian sớm nhất.",
                    icon: "success",
                    className: 'swal-modal-admin-action',
