            ...
            <div class="col-lg-6 col-md-6 col-sm-6" style="padding: 70px 0px;">
                <div class="register-form"><h1 class="name">Đăng ký</h1> <!---->
                    <form method="post" action="{{ url('/dang-ky') }}" id="signup-form" name="signup-form" novalidate="novalidate">
                        {{ csrf_field() }}
                        <div class="form-group ps-relative"><label for="fullname">Họ tên <span class="text-danger">*</span></label> <span class="error hide"></span> <input type="text" id="fullname" name="fullname" class="form-control"></div>
                        <div class="form-group ps-relative"><label for="email">Email <span class="text-danger">*</span></label> <span class="error hide"></span> <input type="text" id="email" name="email" class="form-control"></div>
                        <div class="form-group"><label for="password">Mật khẩu <span class="text-danger">*</span></label> <span class="error hide"></span> <input type="password" id="password" name="password" class="form-control"></div>
                        <div class="form-group"><label for="re_password" class="">Nhập lại mật khẩu <span class="text-danger">*</span></label> <span class="error hide"></span> <input type="password" id="re_password" name="re_password" class="form-control"></div>
                        <span class="error hide mb-12 fs-16 fw-bold"></span> <input type="hidden" id="g-recaptcha-response" name="captcha"
                        ...
                        <button type="submit" id="sign-up-submit" class="btn btn-default">Đăng ký</button>
                    </form>
                </div>
            </div>
        </div>
