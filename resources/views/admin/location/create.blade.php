    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left input_mask" action="{{ url('cms/locations/store') }}" method="post" id="postForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 col-xs-12">Tên châu lục <span
                                    class="required">*</span></label>
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                <input type="text" class="form-control" name="continent" required="required">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <div class="radio">
                                    <input type="checkbox" value="1" name="top_search" class="flat">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <div class="radio">
                                    <input type="checkbox" value="1" name="hot_location" class="flat">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <div class="radio">
                                    <input type="checkbox" value="1" name="popular_location" class="flat">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
