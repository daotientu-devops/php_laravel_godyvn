    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form class="form-horizontal form-label-left input_mask" action="{{ url('cms/destinations/store') }}" method="post" id="postForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <div class="radio">
                                    <input type="checkbox" value="1" name="is_reviewed" class="flat">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
